...
function Expenses() {
  ...
  const openCreate = () => {
    ...
    reset({ category: "", amount: 0, description: "", expenseDate: "", paymentMethod: "Cash", reference: "" });
    setModalOpen(true);
  };
    ...
    <div>
      ...
      >
        ...
        <FormField label="Amount" name="amount" error={errors.amount?.message} required>
          <Input type="number" step="0.01" {...register("amount", { valueAsNumber: true })} placeholder="0" />
        </FormField>
